...
def view_portafolio():
    ...
    for index, row in df.iterrows():
        ...
        with st.expander(f"{icono} {row['ID']} - {row['Título']} (Score: {score})"):
            # El resto del código para mostrar las pestañas y detalles de la licitación va aquí...
            # (Se omite por brevedad, ya que no cambia)
            st.write(f"Detalles para la licitación {row['ID']}...")
